...
final class BibleService {
    ...
    private func loadBooks() {
        books = [
            ...
            BibleBook(id: "neh", name: "Neemias", abbreviation: "Ne", testament: .oldTestament, chapterCount: 13, icon: "brick.fill", category: .history),
            ...
            BibleBook(id: "dan", name: "Daniel", abbreviation: "Dn", testament: .oldTestament, chapterCount: 12, icon: "lion", category: .majorProphets),
            ...
            BibleBook(id: "jon", name: "Jonas", abbreviation: "Jn", testament: .oldTestament, chapterCount: 4, icon: "fish", category: .minorProphets),
